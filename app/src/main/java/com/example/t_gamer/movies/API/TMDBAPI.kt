...
interface TMDBAPI {
    ...
    @GET("discover/movie?api_key=548202cec0f96e480f6e8aa312dd3d3b&language=pt-BR&include_adult=true")
    fun getMoviesByGenre(
        @Query("with_genres") id: Int
    ): Call<MovieResultViewModel>

    @GET("search/movie?api_key=548202cec0f96e480f6e8aa312dd3d3b&language=pt-BR&include_adult=true&")
    fun getMovieByTitle(
